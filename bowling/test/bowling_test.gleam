...
/// Unit tests 
// pub fn distribute_rolls_test() {
//   let rolls_strike_length_10 = [
//     1, 2, 3, 4, 5, 6, 7, 8, 10, 4, 4, 4, 0, 10, 4, 4, 10,
//   ]
//
//   rolls_strike_length_10
//   |> produce_frames
//   |> list.length
//   |> should.equal(10)
// }
//
// pub fn distribute_rolls_length_11_test() {
//   let rolls_strike_length_11 = [
//     1, 2, 3, 4, 5, 6, 7, 8, 10, 4, 4, 4, 0, 10, 4, 4, 10, 10,
//   ]
//
//   rolls_strike_length_11
//   |> produce_frames
//   |> list.length
//   |> should.equal(11)
// }
//
// pub fn distribute_rolls_without_strik_test() {
//   let rolls = [1, 2, 3, 4]
//
//   rolls
//   |> produce_frames
...
// }
//
// pub fn distribute_rolls_with_double_strike_test() {
//   let rolls = [1, 2, 10, 10, 3, 5]
//
//   rolls
//   |> produce_frames
//   |> should.equal([
...
// }
//
// pub fn distribute_bonus_with_quad_strike_test() {
//   [
//     Frame([1, 2], []),
//     Frame([10], []),
//     Frame([10], []),
...
// }
//
// pub fn distribute_bonus_with_single_spare_test() {
//   [
//     Frame([1, 2], []),
//     Frame([5, 5], []),
//     Frame([4, 2], []),
...
// }
//
// pub fn distribute_bonus_with_single_spare_lookahead_test() {
//   [
//     Frame([1, 2], []),
//     Frame([5, 5], []),
//     Frame([4, 2], []),
...
// }
//
// pub fn distribute_bonus_with_single_strike_lookahead_test() {
//   [
//     Frame([1, 2], []),
//     Frame([5, 3], []),
//     Frame([10], []),
...
// }
//
// pub fn distribute_bonus_with_double_strike_lookahead_test() {
//   [
//     Frame([1, 2], []),
//     Frame([10], []),
//     Frame([10], []),
...
// }
//
// pub fn distribute_bonus_with_tripple_strike_lookahead_test() {
//   [
//     Frame([1, 2], []),
//     Frame([10], []),
//     Frame([10], []),
